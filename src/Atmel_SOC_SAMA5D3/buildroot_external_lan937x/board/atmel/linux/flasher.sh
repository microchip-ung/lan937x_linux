...
#program = "yes" or "no"
$1/host/opt/sam-ba/sam-ba $TTY ${!M} $(dirname $0)/nandflash.tcl -- ${!F} ${!D} $video_mode "yes" "yes"

#For just to generate the uboot environment file enable following line and comment out the above line
#$1/host/opt/sam-ba/sam-ba $TTY ${!M} $(dirname $0)/nandflash.tcl -- ${!F} ${!D} $video_mode "yes" "no"
